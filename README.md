...
## V7.4 — دورة التشغيل الكاملة للطلب
- مساحة تنفيذ موحدة للعميل ومقدم الخدمة.
- مراحل: تأكيد المتطلبات → التنفيذ → التسليم → الاعتماد.
- مقدم الخدمة يستطيع بدء التنفيذ ورفع تسليم فعلي من الجهاز (مع حفظ بيانات النسخة محليًا في الوضع التجريبي).
- العميل يستطيع اعتماد التسليم أو طلب تعديل، مع سجل نسخ وتسلسل زمني.
- عند الاعتماد في الوضع التجريبي يتحول الطلب إلى «تم التنفيذ» وتُحرر حالة الدفع التجريبية.
- V7.4 يضع تجربة دورة الطلب كاملة في واجهة واحدة؛ ربط الملفات والتحديثات الماليّة عبر Supabase يحتاج تطبيق SQL المرفق في الإصدارات التالية/بيئة الإنتاج.
